...
@section('content')
    <div class="container-fluid py-4 min-vh-100 d-flex align-items-center justify-content-center">
        <div class="w-100" style="max-width: 900px;">
            ...
            <form action="{{ route('automasi.climate.store', $device->id) }}" method="POST">
                @csrf
                            ...
                            <div class="card-body position-relative" style="z-index: 1;">
                                ...
                                <div class="mb-4">
                                    ...
                                    <div class="input-group">
                                        <input type="number" step="0.1" name="ats_suhu"
                                            value="{{ $settings['ats_suhu'] ?? '' }}"
                                            class="form-control form-control-lg text-center fw-bold" placeholder="0">
                                        <span class="input-group-text fw-bold bg-white text-dark">°C</span>
                                    </div>
                                </div>
                                ...
                                <div class="mb-4">
                                    ...
                                    <div class="input-group">
                                        <input type="number" step="0.1" name="bwh_suhu"
                                            value="{{ $settings['bwh_suhu'] ?? '' }}"
                                            class="form-control form-control-lg text-center fw-bold" placeholder="0">
                                        <span class="input-group-text fw-bold bg-white text-dark">°C</span>
                                    </div>
                                </div>
                        ...
                        <div class="card card-glass border-0 shadow-lg h-100 position-relative overflow-hidden">
                            ...
                            <div class="card-body position-relative" style="z-index: 1;">
                                ...
                                <div class="mb-4">
                                    <label class="form-label text-white fw-bold fs-5">Batas Atas</label>
                                    <div class="input-group">
                                        <input type="number" step="0.1" name="ats_kelem"
                                            value="{{ $settings['ats_kelem'] ?? '' }}"
                                            class="form-control form-control-lg text-center fw-bold" placeholder="0">
                                ...
                                <div class="mb-4">
                                    <label class="form-label text-white fw-bold fs-5">Batas Bawah</label>
                                    <div class="input-group">
                                        <input type="number" step="0.1" name="bwh_kelem"
                                            value="{{ $settings['bwh_kelem'] ?? '' }}"
                                            class="form-control form-control-lg text-center fw-bold" placeholder="0">
                                        <span class="input-group-text fw-bold bg-white text-dark">%</span>
                                    </div>
                                </div>
